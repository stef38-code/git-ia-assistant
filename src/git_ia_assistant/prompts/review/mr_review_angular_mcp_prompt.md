...
5. **Standards Angular {version_cible}** : Utilise tes outils pour vérifier si le projet respecte les nouveaux patterns cibles (Signals, Standalone, Control Flow, Zoneless).
...
- Gestion correcte des mémoire (unsubscribe / async pipe)
