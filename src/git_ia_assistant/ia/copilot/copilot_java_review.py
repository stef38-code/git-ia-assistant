...
"""
NAME
    copilot_java_review - Effectue une revue de code Java avec Copilot.

DESCRIPTION
    Ce script envoie le code Java à Copilot pour obtenir une analyse sur les
    bugs potentiels, les optimisations et le respect des bonnes pratiques,
    en tenant compte de la version de Java.

SYNOPSIS
    python copilot_java_review.py VOTRE_FICHIER.java [VERSION]

FUNCTIONS
    obtenir_revue_ia(chemin_fichier: str, version: str = "17", ia: str = "copilot") -> None
...
def obtenir_revue_ia(
    chemin_fichier: str, version: str = "17", ia: str = "copilot"
) -> None:
    """
    Envoie le code à l'IA pour une analyse technique.
    ...
    try:
        ...
        return
    prompt_template = charger_prompt("review/java_review_prompt.md")
