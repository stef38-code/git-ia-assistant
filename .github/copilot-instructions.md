...
```
**Important** : 
- Marquer les options obligatoires avec le tag **(OBLIGATOIRE)** en fin de description.
- Ne pas ajouter la section `FUNCTIONS`, elle ne doit être présente que dans des scripts de type librairie.
